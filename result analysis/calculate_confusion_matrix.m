...
%input: CV_CNN predict about train or val data; train or val label
% *****************************************************************
load test_label_2620.mat;
load class_test4.mat;
test_label = test_label_2620 + 1;
test_output = class_test4';
m = size(test_label,1);
%% 
num1 = length(find(test_label==1));
num2 = length(find(test_label==2));
num3 = length(find(test_label==3));
num4 = length(find(test_label==4));
num5 = length(find(test_label==5));
num6 = length(find(test_label==6));
num7 = length(find(test_label==7));
num8 = length(find(test_label==8));
num9 = length(find(test_label==9));
num10 = length(find(test_label==10));
num11 = length(find(test_label==11));
num12 = length(find(test_label==12));
num13 = length(find(test_label==13)); 
num14 = length(find(test_label==14));
...
m1_13 = length(find(temp1==13)); m1_14 = length(find(temp1==14)); 
m1= [m1_1/num1, m1_2/num1,m1_3/num1,m1_4/num1, m1_5/num1,m1_6/num1,m1_7/num1,m1_8/num1 , m1_9/num1,m1_10/num1,m1_11/num1 ,m1_12/num1,m1_13/num1,m1_14/num1 ];
accuracy1 = m1_1/num1;
...
mask = zeros(m,1);
for i = 1:m    
        if (test_label(i,1)==11)
            mask(i,1) = 1;
        else 
            mask(i,1) = 0;
        end
end
temp11= mask.*test_output;
...
mask = zeros(m,1);
for i = 1:m    
        if (test_label(i,1)==12)
            mask(i,1) = 1;
        else 
            mask(i,1) = 0;
        end
end
temp12= mask.*test_output;
...
mask = zeros(m,1);
for i = 1:m    
        if (test_label(i,1)==13)
            mask(i,1) = 1;
        else 
            mask(i,1) = 0;
        end
end
temp13= mask.*test_output;
...
mask = zeros(m,1);
for i = 1:m    
        if (test_label(i,1)==14)
            mask(i,1) = 1;
        else 
            mask(i,1) = 0;
        end
end
temp14= mask.*test_output;
